...
sLogFile =  '/home/rgtm02-mic/Data/Antonin/logkilo_tet.csv';
sFilter = 'tet'; % will cluster only exp with that in their name
nNumChans = 4;
bTetrode = true;
...
for nFileNum = 1:numel(stDirRoot)
    ...
    % define the channel map as a filename (string) or simply an array
      [sChannelMapFileName] = createChannelMapFile(ops.NchanTOT, sRootPath, bTetrode); % create the map file
