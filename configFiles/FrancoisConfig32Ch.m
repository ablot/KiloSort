function [ops] = FrancoisConfig32Ch(sRootDir, sExpName, sLogFile, sFilter, ... 
                                nNumChans)
...
ops.fbinary             = fullfile(sRootPath, [sExpName, '.dat']); % will be created for 'openEphys'
...
ops.Nfilt               = nNumChans*2;           % number of filters to use (2-4 times more than Nchan, should be a multiple of 32)     		
...
ops.whiteningRange      = nNumChans; % how many channels to whiten together (Inf for whole probe whitening, should be fine if Nchan<=32)		
		
% define the channel map as a filename (string) or simply an array
% 
[sChannelMapFileName] = createChannelMapFile(ops.NchanTOT, sRootDir,...
        bTetrode); % create the map file
ops.chanMap             = sChannelMapFileName; % make this file
                                               % using
